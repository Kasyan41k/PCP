...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#37c3c67a#;
   ...
   u00092 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00092, "ada__real_timeB");
   u00093 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00093, "ada__real_timeS");
   u00094 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00094, "system__taskingB");
   u00095 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00095, "system__taskingS");
   u00096 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00096, "system__task_primitivesS");
   u00097 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00097, "system__os_interfaceS");
   u00098 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00098, "interfaces__c__stringsB");
   u00099 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00099, "interfaces__c__stringsS");
   u00100 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00100, "system__task_primitives__operationsB");
   u00101 : constant Version_32 := 16#9723968e#;
   ...
   u00103 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00103, "system__float_controlS");
   u00104 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00104, "system__interrupt_managementB");
   u00105 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00105, "system__interrupt_managementS");
   u00106 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00106, "system__multiprocessorsB");
   u00107 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00107, "system__multiprocessorsS");
   u00108 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00108, "system__os_primitivesB");
   u00109 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00109, "system__os_primitivesS");
   u00110 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00110, "system__arith_64B");
   u00111 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00111, "system__arith_64S");
   u00112 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00112, "system__task_lockB");
   u00113 : constant Version_32 := 16#4e70667a#;
   ...
   u00116 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00116, "system__task_infoS");
   u00117 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00117, "system__tasking__debugB");
   u00118 : constant Version_32 := 16#d3b35c55#;
   ...
   u00120 : constant Version_32 := 16#2d5a86c4#;
   ...
   u00123 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00123, "system__stack_usageB");
   u00124 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00124, "system__stack_usageS");
   u00125 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00125, "ada__strings__text_buffersB");
   u00126 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00126, "ada__strings__text_buffersS");
   u00127 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00127, "ada__strings__utf_encodingB");
   u00128 : constant Version_32 := 16#37e3917d#;
   ...
   u00130 : constant Version_32 := 16#103ad78c#;
   ...
   u00143 : constant Version_32 := 16#5fc04ee2#;
   pragma Export (C, u00143, "system__put_imagesB");
   u00144 : constant Version_32 := 16#52d4e162#;
   pragma Export (C, u00144, "system__put_imagesS");
   u00145 : constant Version_32 := 16#e264263f#;
   pragma Export (C, u00145, "ada__strings__text_buffers__utilsB");
   u00146 : constant Version_32 := 16#608bd105#;
   pragma Export (C, u00146, "ada__strings__text_buffers__utilsS");
   u00147 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00147, "interfaces__c_streamsB");
   u00148 : constant Version_32 := 16#066a78a0#;
   pragma Export (C, u00148, "interfaces__c_streamsS");
   u00149 : constant Version_32 := 16#30f1a29e#;
   pragma Export (C, u00149, "system__file_ioB");
   u00150 : constant Version_32 := 16#888bb071#;
   pragma Export (C, u00150, "system__file_ioS");
   u00151 : constant Version_32 := 16#86c56e5a#;
   pragma Export (C, u00151, "ada__finalizationS");
   u00152 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00152, "system__finalization_rootB");
   u00153 : constant Version_32 := 16#60082284#;
   pragma Export (C, u00153, "system__finalization_rootS");
   u00154 : constant Version_32 := 16#d265cbbc#;
   pragma Export (C, u00154, "system__file_control_blockS");
   u00155 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00155, "system__random_numbersB");
   u00156 : constant Version_32 := 16#19a1600c#;
   pragma Export (C, u00156, "system__random_numbersS");
   u00157 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00157, "system__random_seedB");
   u00158 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00158, "system__random_seedS");
   u00159 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00159, "ada__calendarB");
   u00160 : constant Version_32 := 16#31350a81#;
